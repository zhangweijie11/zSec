...
import (
	...
	"github.com/zhangweijie11/zSec/zero_trust/zero_trust_proxy/authentication"
	"github.com/zhangweijie11/zSec/zero_trust/zero_trust_proxy/authentication/providers"
	"github.com/zhangweijie11/zSec/zero_trust/zero_trust_proxy/authentication/providers/google"
	"github.com/zhangweijie11/zSec/zero_trust/zero_trust_proxy/authorization"
	"github.com/zhangweijie11/zSec/zero_trust/zero_trust_proxy/logger"
	"github.com/zhangweijie11/zSec/zero_trust/zero_trust_proxy/proxy"
	"github.com/zhangweijie11/zSec/zero_trust/zero_trust_proxy/vars"
	"gopkg.in/yaml.v2"
	"io/ioutil"
	"net/http"
	"net/url"
